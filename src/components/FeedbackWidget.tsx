...
export default function FeedbackWidget() {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 md:bottom-6 right-6 bg-accent hover:bg-accent/90 text-white p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-105 group z-50"
