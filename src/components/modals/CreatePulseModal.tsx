...
export default function CreatePulseModal({ isOpen, onClose, onSuccess }: CreatePulseModalProps) {
  ...
  const [enforcementMode, setEnforcementMode] = useState<EnforcementMode>('SCORE_BASED');
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-3">
                        Which signal escalates your discipline constraints?
                      </p>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        ...
                        >
                          <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className={`text-sm font-semibold ${enforcementMode === 'SCORE_BASED' ? 'text-blue-300' : 'text-gray-300'}`}>
                              Score-based
                            </span>
                            <span className="text-[10px] uppercase tracking-wider text-blue-400/70 ml-auto">
                              Recommended
                            </span>
                          </div>
                          <p className="text-xs text-gray-400 leading-snug">
                            Recovery via clean sessions. Builds discipline through action.
                          </p>
                        </button>
                        <button
                          type="button"
                        ...
                        >
                          <div className="flex items-center gap-1.5 mb-1">
                            ...
                            <span className={`text-sm font-semibold ${enforcementMode === 'SEVERITY_BASED' ? 'text-purple-300' : 'text-gray-300'}`}>
                              Severity-based
                            </span>
                          </div>
                          <p className="text-xs text-gray-400 leading-snug">
                            Monday clears last week&apos;s slate. More forgiving by design.
                          </p>
                        </button>
                      </div>
                    </div>
