...
export function calculatePeriodChanges(
	...
	currentStats.avgWin =
		currentStats.totalWins > 0
			? currentStats.totalProfitLoss / currentStats.totalWins
			: 0

	currentStats.avgLoss =
		currentStats.totalLosses > 0
			? currentStats.totalProfitLoss / currentStats.totalLosses
			: 0

	previousStats.avgWin =
		previousStats.totalWins > 0
			? previousStats.totalProfitLoss / previousStats.totalWins
			: 0

	previousStats.avgLoss =
		previousStats.totalLosses > 0
			? previousStats.totalProfitLoss / previousStats.totalLosses
			: 0
